...
using BestReads.Server.Features.Identity;
using BestReads.Server.Infrastructure.Filters;
...
namespace BestReads.Server.Infrastructure.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddDatabase(
            ...
            => services
                .AddDbContext<BestReadsDbContext>(options => options
        ...
        public static IServiceCollection AddIdentity(this IServiceCollection services)
        {
            services
                ...
                .AddEntityFrameworkStores<BestReadsDbContext>();
